...
docker build --force-rm -t "Arslan.Vms/gateway-web-public:${IMAGE_TAG}" .
...
docker build --force-rm -t "Arslan.Vms/service-ordering:${IMAGE_TAG}" .

echo "**************** BUILDING CMSKIT-SERVICE 12/$total ****************"
cd ${currentFolder}/services/cmskit/src/Arslan.Vms.CmskitService.HttpApi.Host
docker build --force-rm -t "Arslan.Vms/service-cmskit:${IMAGE_TAG}" .
