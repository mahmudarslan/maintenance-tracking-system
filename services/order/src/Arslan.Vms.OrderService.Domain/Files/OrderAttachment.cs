...
{
    public class OrderAttachment : FullAuditedAggregateRoot<Guid>, IFileAttachment, IMultiTenant
    {
        ...
        public OrderAttachment(Guid? tenantId, string fileName, string extension, string contentType, byte[] data, Guid downloadGuid, bool useDownloadUrl, string downloadUrl, string path, bool ısNew)
        {
            TenantId = tenantId;
            FileName = fileName;
            Extension = extension;
