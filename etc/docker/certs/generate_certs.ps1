...
Export-PfxCertificate -Cert $rootCA -FilePath Arslan.Vms-root-cert.pfx -Password $password | Out-Null
...
Export-Certificate -Cert $rootCA -FilePath Arslan.Vms-root-cert.cer -Type CERT | Out-Null
