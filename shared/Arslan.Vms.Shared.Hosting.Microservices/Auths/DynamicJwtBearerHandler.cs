...
public class DynamicJwtBearerHandler : JwtBearerHandler
{
    ...
    public DynamicJwtBearerHandler(IOptionsMonitor<JwtBearerOptions> options,
                                   ILoggerFactory logger,
                                   UrlEncoder encoder,
                                   ISystemClock clock,
                                   IDynamicJwtBearerHanderConfigurationResolver dynamicJwtBearerHanderConfigurationResolver)
    ...
    protected override async Task<AuthenticateResult> HandleAuthenticateAsync()
    {
        ...
        try
        {
            ...
            var currentConfiguration = await dynamicJwtBearerHanderConfigurationResolver.ResolveCurrentOpenIdConfiguration(Context);
