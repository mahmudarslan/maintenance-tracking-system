...
public class CustomAuditLogInfoToAuditLogConverter : IAuditLogInfoToAuditLogConverter, ITransientDependency
{
    ...
    public CustomAuditLogInfoToAuditLogConverter(IGuidGenerator guidGenerator, IExceptionToErrorInfoConverter exceptionToErrorInfoConverter, IJsonSerializer jsonSerializer, IOptions<AbpExceptionHandlingOptions> exceptionHandlingOptions)
    {
    ...
    public virtual Task<AuditLog> ConvertAsync(AuditLogInfo auditLogInfo)
    {
        ...
        var remoteServiceErrorInfos = auditLogInfo.Exceptions?.Take(1).Select(exception => ExceptionToErrorInfoConverter.Convert(exception, options =>
                                          {
