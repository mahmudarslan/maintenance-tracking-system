...
public class KeyCloakDataSeeder : IDataSeedContributor, ITransientDependency
{
    ...
    private async Task CreateClientsAsync()
    {
        ...
        await CreateSwaggerClientAsync(); // TODO: Test when Volo.Abp.Swashbuckle v6.0.0 is released (https://github.com/abpframework/abp/pull/14409)
    ...
    private async Task CreateAdministrationClientAsync()
    {
        var administrationClient =
            (await _keycloakClient.GetClientsAsync(_keycloakOptions.RealmName,
                clientId: "Arslan.Vms_AdministrationService"))
            .FirstOrDefault();
        ...
        if (administrationClient == null)
        {
            ...
            await AddOptionalClientScopesAsync(
                "Arslan.Vms_AdministrationService",
                new List<string>
                {
                    "IdentityService"
                }
            ...
            var insertedClient =
                (await _keycloakClient.GetClientsAsync(_keycloakOptions.RealmName, clientId: "Arslan.Vms_AdministrationService"))
                .First();
    ...
    {
        var cmsKitClient =
            (await _keycloakClient.GetClientsAsync(_keycloakOptions.RealmName, clientId: "Arslan.Vms_CmskitService"))
            .FirstOrDefault();
        ...
        if (cmsKitClient == null)
        {
            ...
            {
                ClientId = "Arslan.Vms_CmskitService",
